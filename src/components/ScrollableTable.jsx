...
const ScrollableTable = () => {
          ...
          <tbody>
            {resdata.map((row) => (
              <tr key={row.id}>
                <td>
                  <input
                    style={isedit[row.id] ? {} : { cursor: "not-allowed" }}
                ...
                <input
                  style={isedit[row.id] ? {} : { cursor: "not-allowed" }}
                    ...
                    onChange={(e) => handleInputChange(e, row.id, "passport")}
                  />
                </td>
                <td>
                <input
                ...
                <input
                  style={isedit[row.id] ? {} : { cursor: "not-allowed" }}
                    ...
                    onChange={(e) => handleInputChange(e, row.id, "nationality")}
                  />
                </td>
                <td>
                <input
                  style={isedit[row.id] ? {} : { cursor: "not-allowed" }}
                    ...
                    onChange={(e) => handleInputChange(e, row.id, "uaeResident")}
                  />
                </td>
                <td>{row.col10}</td>
                <td>{row.col11}</td>
                ...
                <input
                  style={isedit[row.id] ? {} : { cursor: "not-allowed" }}
                    ...
                    onChange={(e) => handleInputChange(e, row.id, "token")}
                  />
                </td>
                <td>
                <input
                  style={isedit[row.id] ? {} : { cursor: "not-allowed" }}
                    ...
                    onChange={(e) => handleInputChange(e, row.id, "closure")}
                  />
                </td>
                <td>
                <input
                  style={isedit[row.id] ? {} : { cursor: "not-allowed" }}
                    ...
                    onChange={(e) => handleInputChange(e, row.id, "booking")}
                  />
                </td>
  ...
  <RiDownloadFill />
                ...
                <td>{row.col18}</td>
                <td>
                <button onClick={() => openModal(row.image)}> Image
